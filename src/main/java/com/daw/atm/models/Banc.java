...
public class Banc {
	...
	public Banc() {
		...
		llistaClients.add(
				new Client("Ana", "Ponts Sants", "12341234A", LocalDate.parse("2000-01-08"), "aponts@correu.com"));
		llistaClients.add(
				new Client("Carlos", "Ponts Sants", "23442345A", LocalDate.parse("2000-01-08"), "cponts@correu.com"));
		llistaClients.add(
				new Client("Felip", "Ponts Sants", "55341234A", LocalDate.parse("2000-01-08"), "fponts@correu.com"));
		llistaClients.add(
				new Client("Esther", "Ponts Sants", "66341234A", LocalDate.parse("2000-01-08"), "eponts@correu.com"));
		llistaClients.add(
				new Client("Sandra", "Ponts Sants", "77341234A", LocalDate.parse("2000-01-08"), "sponts@correu.com"));
		...
		llistaTargetes.add(new Targeta("111111111111A", LocalDate.parse("2027-01-01"), 111, 1111,
				(CompteCorrent) llistaComptes.get(0)));
		llistaTargetes.add(new Targeta("222222222222B", LocalDate.parse("2027-01-01"), 222, 2222,
				(CompteCorrent) llistaComptes.get(1)));
		llistaTargetes.add(new Targeta("333333333333C", LocalDate.parse("2027-01-01"), 333, 3333,
				(CompteCorrent) llistaComptes.get(2)));
		llistaTargetes.add(new Targeta("444444444444D", LocalDate.parse("2027-01-01"), 444, 4444,
				(CompteCorrent) llistaComptes.get(3)));
		llistaTargetes.add(new Targeta("555555555555E", LocalDate.parse("2027-01-01"), 555, 5555,
